      ...
      {showEmojiPicker ? (
          ...
          <div className="grid grid-cols-4 gap-1">
            {QUICK_EMOJIS.map((emoji) => (
              <button
                ...
                className="w-9 h-9 flex items-center justify-center rounded-md hover:bg-zinc-700 text-lg transition-colors"
              >
                {emoji}
              </button>
            ))}
        ...
        <>
          <button
            ...
            className="w-full px-3 py-2 text-left text-sm text-zinc-200 hover:bg-zinc-700 flex items-center gap-2 transition-colors"
          >
    ...
    <div className="flex flex-wrap gap-1 mt-1">
      {entries.map(([emoji, users]) => (
        <button
          ...
          className="flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-zinc-700/50 hover:bg-zinc-700 border border-zinc-600/50 text-xs transition-colors"
          title={users.join(", ")}
        >
          <span>{emoji}</span>
