...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  Billing: "bg-orange-500/10 text-orange-400 border-orange-500/20",
};
...
export function CannedResponsePopover({
  ...
  return (
    <div className="absolute bottom-full left-0 right-0 mb-2 z-50">
      <div className="bg-zinc-900 border border-zinc-700 rounded-xl shadow-2xl overflow-hidden max-h-72">
        ...
        <div ref={listRef} className="max-h-56 overflow-y-auto">
          {isLoading ? (
            ...
            <div className="py-6 text-center">
              <p className="text-xs text-zinc-500">No matching responses</p>
        ...
        <div className="px-3 py-1.5 border-t border-zinc-800 bg-zinc-900/80">
