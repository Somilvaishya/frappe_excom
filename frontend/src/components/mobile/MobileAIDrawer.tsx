          ...
          <div className="space-y-6">
                  ...
                  {next_actions.map((action, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <p className="text-sm text-zinc-300">{action.action}</p>
                        <Badge className="mt-1 text-[10px] bg-zinc-800 text-zinc-400 border-zinc-700 border">
                          {action.priority}
                        </Badge>
                      </div>
                    </div>
            ...
            <div className="space-y-3">
              ...
              {suggested_replies.length > 0 ? (
                ...
                <p className="text-xs text-zinc-500">No reply suggestions yet</p>
              )}
            </div>
            ...
            <div className="space-y-3 pb-6">
              ...
              <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-xl p-4 border border-blue-500/20 space-y-2">
