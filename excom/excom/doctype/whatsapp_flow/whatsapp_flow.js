...
function fetch_and_show_flows(whatsapp_account, frm) {
    frappe.call({
        method: "excom.excom.doctype.whatsapp_flow.whatsapp_flow.get_whatsapp_flows",
        args: {
...
function import_flow(whatsapp_account, flow_id, flow_name, frm) {
    frappe.call({
        method: "excom.excom.doctype.whatsapp_flow.whatsapp_flow.import_flow_from_whatsapp",
        args: {
            whatsapp_account: whatsapp_account,
            flow_id: flow_id,
            flow_name: flow_name
